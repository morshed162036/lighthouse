                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form method="post" action="{{ route('academic_calender.update',$academic_calender->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="table-responsive">
                                           <div >
                                            ...
                                            <h3 class="mt-3">Title</h3>
                                                <input type="text" value="{{$academic_calender->title}}" class="form-control" aria-describedby="basic-Createon1" name="title">
                                            <h3 class="mt-3">Pdf File</h3>
                                                <input value="{{$academic_calender->pdf_file}}" type="file" class="form-control" aria-describedby="basic-Createon1" name="pdf_file" onchange="loadFile(event)">
                                        </div>
                                      
                                        {{-- <img src="{{ asset('images/academic_calenders/'.$academic_calender->pdf_file) }}" id="output" alt="img" width="100px" height="auto" class="mt-2 mx-1"> --}}
