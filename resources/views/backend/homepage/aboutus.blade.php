            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('homeAboutUs') }}" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="{{ old('title',$aboutus->title) }}" required>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        @if($aboutus->image != null)
                                            <img src="{{ asset('images/aboutus/'.$aboutus->image) }}" id="bg" alt="bg" width="450px" height="400px" class="mt-2 mx-1">
                                        @endif
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="content"  class="form-control" id="content" cols="30" rows="10" required>{{ old('content',$aboutus->content) }}</textarea>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
