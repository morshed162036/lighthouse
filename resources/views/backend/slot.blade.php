            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Slot Section
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="@if ($slot) {{ route('slot',$slot->id) }} @else {{ route('slot') }} @endif" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="@if ($slot) {{ old('title',$slot->title) }}@endif">
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control" aria-describedby="basic-Createon1" name="time" value="@if ($slot) {{ old('time',$slot->time) }}@endif">
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                {{-- <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="@if ($slot) {{ old('title',$slot->title) }}@endif" required> --}}
                                ...
                                <div class="col-md-2 mt-2">
                                    <button type="submit" class="btn btn-primary mt-2 btn-lg">@if ($slot)
                                        Update
                                    @else
                                        Create
                                    @endif </button>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">slot List</h5>
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li class="ml-2"><a href="{{ route('slot') }}" class="btn btn-primary">+ Create</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-content">
                                    ...
                                    <tbody>
                                        @if ($slots)
                                            @foreach ($slots as $slot)
                                                <tr>
                                                    {{-- <td class="text-bold-600" ><img src="{{ asset('images/slot/'.$slot->image) }}" alt="" height="150px"></td> --}}
                                                    <td><a href="{{ route('slot',$slot->id) }}">{{ $slot->title }}</a></td>
                                                    <td>{{ $slot->time }}</td>
                                                    <td>{{ $slot->status }}</td>
                                                </tr>
                                            @endforeach
