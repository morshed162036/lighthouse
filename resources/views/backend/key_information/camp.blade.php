            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Camps Section
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="@if ($camp) {{ route('camps',$camp->id) }}@endif" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="@if ($camp) {{ old('title',$camp->title) }}@endif" readonly>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="content"  class="form-control" id="content" cols="30" rows="10" required> @if ($camp)
                                                    {{ old('content',$camp->content) }}
                                                @endif</textarea>
                                            </div>
                                        </fieldset>
                                    </div>
                        ...
                        <div class="card-body card-dashboard">
                            <div class="table-responsive">
                                <table class="table zero-configuration">
                                    ...
                                    <tbody>
                                        @if ($camps)
                                            @foreach ($camps as $campe)
                                                <tr>
                                                    <td class="text-bold-600" ><img src="{{ asset('images/camps/'.$campe->image) }}" alt="" height="150px"></td>
                                                    {{-- <td>{{ $banner->first_text }}</td>--}}
                                                    <td><a href="{{ route('camps',$campe->id) }}">{{ $campe->title }}</a></td>
                                                    {{-- <td>{!! $campe->content !!}</td> --}}
                                                </tr>
                                            @endforeach
                                        @else
    ...
    <script>
        ClassicEditor
            .create( document.querySelector( '#content' ),{
                ckfinder:{
                    uploadUrl:"{{ route('camp.upload',['_token' => csrf_token()]) }}",
                }
            } )
