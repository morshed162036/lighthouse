            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Hero Section
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('addmissionProcedure') }}" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="{{ old('title',$addmission->title) }}">
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="content"  class="form-control" id="content" cols="30" rows="10" required>{{ old('content',$addmission->content) }}</textarea>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
