            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Achievement Section
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="@if ($achievement) {{ route('achievement',$achievement->id) }} @else {{ route('achievement') }} @endif" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="@if ($achievement) {{ old('title',$achievement->title) }}@endif" required>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if ($achievement)
                                            @if($achievement->image != null)
                                                <img src="{{ asset('images/achievement/'.$achievement->image) }}" id="bg" alt="bg" width="200px" height="200px" class="mt-2 mx-1">
                                            @endif
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="content"  class="form-control" id="content" cols="30" rows="10" required> @if ($achievement)
                                                    {{ old('content',$achievement->content) }}
                                                @endif</textarea>
                                            </div>
                                        </fieldset>
                                    </div>
                                ...
                                <div class="col-md-2 mt-2">
                                    <button type="submit" class="btn btn-primary mt-2 btn-lg">@if ($achievement)
                                        Update
                                    @else
                                        Create
                                    @endif </button>
                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li class="ml-2"><a href="{{ route('achievement') }}" class="btn btn-primary">+ Create</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            <div class="table-responsive">
                                <table class="table zero-configuration">
                                    ...
                                    <tbody>
                                        @if ($achievements)
                                            @foreach ($achievements as $achievemente)
                                                <tr>
                                                    <td class="text-bold-600" ><img src="{{ asset('images/achievement/'.$achievemente->image) }}" alt="" height="150px"></td>
                                                    {{-- <td>{{ $banner->first_text }}</td>--}}
                                                    <td><a href="{{ route('achievement',$achievemente->id) }}">{{ $achievemente->title }}</a></td>
                                                    <td>{{ $achievemente->status }}</td>
                                                </tr>
                                            @endforeach
                                        @else
                                            {{ 'No Data Found' }}
