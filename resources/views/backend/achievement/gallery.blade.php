            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="@if ($gallery) {{ route('adminGallery',$gallery->id) }} @else {{ route('adminGallery') }} @endif" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="@if ($gallery) {{ old('title',$gallery->title) }}@endif" required>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        ...
                                        @if ($gallery)
                                            @if($gallery->image != null)
                                                <img src="{{ asset('images/gallery/'.$gallery->image) }}" id="bg" alt="bg" width="200px" height="200px" class="mt-2 mx-1">
                                            @endif
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="content"  class="form-control" id="content" cols="30" rows="10" required> @if ($gallery)
                                ...
                                <div class="col-md-2 mt-2">
                                    <button type="submit" class="btn btn-primary mt-2 btn-lg">@if ($gallery)
                                        Update
                                    @else
                                        Create
                                    @endif </button>
                                    ...
                                    <tbody>
                                        @if ($galleries)
                                            @foreach ($galleries as $gallery)
                                                <tr>
                                                    <td class="text-bold-600" ><img src="{{ asset('images/gallery/'.$gallery->image) }}" alt="" height="150px"></td>
                                                    {{-- <td>{{ $banner->first_text }}</td>--}}
                                                    <td><a href="{{ route('adminGallery',$gallery->id) }}">{{ $gallery->title }}</a></td>
                                                    <td>{{ $gallery->tab->title }}</td>
