            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Campus campus Section
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="@if ($campus) {{ route('campusGallery',$campus->id) }} @else {{ route('campusGallery') }} @endif" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="@if ($campus) {{ old('title',$campus->title) }}@endif" required>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="file" class="form-control" aria-describedby="basic-Createon1" name="image" onchange="loadBg(event)" required>
                                            </div>
                                        </fieldset>
                                        @if ($campus)
                                            @if($campus->image != null)
                                                <img src="{{ asset('images/campus/'.$campus->image) }}" id="bg" alt="bg" width="200px" height="200px" class="mt-2 mx-1">
                                            @endif
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="content"  class="form-control" id="content" cols="30" rows="10" required> @if ($campus)
                                                    {{ old('content',$campus->content) }}
                                                @endif</textarea>
                                            </div>
                                        </fieldset>
                                    </div>
                                ...
                                <div class="col-md-2 mt-2">
                                    <button type="submit" class="btn btn-primary mt-2 btn-lg">@if ($campus)
                                        Update
                                    @else
                                        Create
                                    @endif </button>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Campus Gallery List</h5>
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li class="ml-2"><a href="{{ route('campusGallery') }}" class="btn btn-primary">+ Create</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-content">
                                    ...
                                    <tbody>
                                        @if ($campuses)
                                            @foreach ($campuses as $campus)
                                                <tr>
                                                    <td class="text-bold-600" ><img src="{{ asset('images/campus/'.$campus->image) }}" alt="" height="150px"></td>
                                                    {{-- <td>{{ $banner->first_text }}</td>--}}
                                                    <td><a href="{{ route('campusGallery',$campus->id) }}">{{ $campus->title }}</a></td>
                                                    <td>{{ $campus->tab->title }}</td>
                                                    <td>{{ $campus->status }}</td>
                                                </tr>
                                            @endforeach
                                        @else
