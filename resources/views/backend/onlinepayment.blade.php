            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Online Payment Section
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('onlinePayment') }}" method="post" enctype="multipart/form-data"> @csrf
                    <div class="card-content collapse show">
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="{{ old('title',$payment->title) }}" required>
                                        </div>
                                    </fieldset>
                                </div>
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" aria-describedby="basic-Createon1" name="tutorial" value="{{ old('tutorial',$payment->tutorial) }}">
                                        </div>
                                    </fieldset>
                                </div>
                                <div class="col-md-6">
                                    <fieldset>
                                        <h5>Online Payment URL <span class="star">*</span></h5>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-Createon1"><i class="bx bx-file"></i></span>
                                            </div>
                                            <input type="text" class="form-control" aria-describedby="basic-Createon1" name="paynow" value="{{ old('paynow',$payment->paynow) }}" required>
                                        </div>
                                    </fieldset>
                                </div>
                                {{-- <div class="col-md-6">
                                    ...
                                    @if($payment->image != null)
                                        <img src="{{ asset('images/payment/'.$payment->image) }}" id="bg" alt="bg" width="450px" height="400px" class="mt-2 mx-1">
                                    @endif
                                </div> --}}
                                <div class="col-md-12 mt-2">
                                    <fieldset>
                                        ...
                                        <div class="input-group">
                                            ...
                                            {{-- <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="{{ old('title',$payment->title) }}" required> --}}
                                            <textarea rows="10" class="form-control" name="content" id="content">{{ old('content',$payment->content) }}</textarea>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <textarea rows="10" class="mb-3 d-none" name="content" id="quill-editor-area">{{ old('content',$payment->content) }}</textarea> --}}
    ...
    <script>
        ClassicEditor
            .create( document.querySelector( '#content' ),{
                ckfinder:{
                    uploadUrl:"{{ route('payment.upload',['_token' => csrf_token()]) }}",
                }
            } )
