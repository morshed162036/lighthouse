            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Polices Section
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('policy') }}" method="post" enctype="multipart/form-data"> @csrf
                    <div class="card-content collapse show">
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="{{ old('title',$policy->title) }}" required>
                                        </div>
                                    </fieldset>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    @if($policy->image != null)
                                        <img src="{{ asset('images/policy/'.$policy->image) }}" id="bg" alt="bg" width="450px" height="400px" class="mt-2 mx-1">
                                    @endif
                                </div>
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="input-group">
                                            ...
                                            {{-- <input type="text" class="form-control" aria-describedby="basic-Createon1" name="title" value="{{ old('title',$policy->title) }}" required> --}}
                                            <textarea rows="10" class="form-control" name="content" id="content">{{ old('content',$policy->content) }}</textarea>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <textarea rows="10" class="mb-3 d-none" name="content" id="quill-editor-area">{{ old('content',$policy->content) }}</textarea> --}}
    ...
    <script>
        ClassicEditor
            .create( document.querySelector( '#content' ),{
                ckfinder:{
                    uploadUrl:"{{ route('policy.upload',['_token' => csrf_token()]) }}",
                }
            } )
